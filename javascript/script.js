...
document.querySelector(".toggle").addEventListener("click", () =>{
    document.querySelector(".fig").innerHTML = "0";
    for (a of all) {
...
function changeNum() {
    if (document.querySelector (".fig").innerHTML > 0) {
        document.querySelector(".fig").innerHTML = 
        document.querySelector(".fig").innerHTML - 1;   }
    else{
        document.querySelector(".fig").innerHTML = 0;
    }
}
